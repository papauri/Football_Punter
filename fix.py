...
pattern = re.compile(r"  getAiConfigPublic\(\) \{  async updateAvailableModels\(\) \{.*?(?=      const primary = this\.aiConfig\?\.primaryProvider || 'mistral';)", re.DOTALL)

replacement = """  async updateAvailableModels() {
